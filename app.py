# app.py
import gradio as gr
from ui.audio_interface import create_audio_interface
from ui.transcription_interface import create_transcription_interface
...
def main():
    with gr.Blocks() as demo:
        ...
        with gr.Tabs() as tabs:
            ...
            with gr.TabItem("Audio Transcription", id="transcription_tab"):
                transcription_interface = create_transcription_interface()
...
#                text2voice_interface = create_text2voice_interface()
        ...
        def on_tab_select(tab: gr.SelectData):
            ...
            elif tab.value == "Transcription":
                return transcription_interface.update()
